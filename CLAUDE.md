...
What's New dialógus, `README.md`, `Visual Assembler Manual.md`, `Visual Assembler Manual.hu.md`, `INSTALL-MAC.md`, `INSTALL-LINUX.md`, `README.txt`, `AGENTS.md`, és ez a fájl + copilot-instructions.md.
