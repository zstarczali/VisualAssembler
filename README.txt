...
2.1.1 highlights: const-aware DELAY / WAIT, PRINT_CHAR, SET_BORDER / SET_BG, refreshed const pickers in block mode, and `.region` directive highlighting in Expert mode.
...
Download the .deb package from the releases page and install:
  ...
  sudo dpkg -i "c64-visual-assembler_2.1.1_amd64.deb"
