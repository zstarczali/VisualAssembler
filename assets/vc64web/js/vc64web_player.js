...
<iframe id="vc64web" width="100%" height="100%" allow="autoplay; fullscreen" src="${this.vc64web_url}${params}#${address}" style="border:none;outline:none;display:block;background:#000;">
</iframe>
<div id="vc64web-player-toolbar" style="display:none;grid-template-columns: repeat(5, auto) 3fr repeat(2, auto);grid-gap: 0.25em;">
...
`;
		...
		vc64web_player.preview_pic_width = parent.width();
                $('#player_container').css("width", "100%");
            }, 100);
        });
